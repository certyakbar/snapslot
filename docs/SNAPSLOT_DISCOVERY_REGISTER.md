...
These items were required as Phase 1 preflight work before implementation begins.
None were done inside the Phase 0.5 package itself. All three are now NORMALIZED.
...
- DISC-0005 through DISC-0007 are marked NORMALIZED with truthful references to the destination docs
